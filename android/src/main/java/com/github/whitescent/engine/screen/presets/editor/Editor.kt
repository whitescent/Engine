    ...
    Box(
      ...
      if (widgetList.isNotEmpty()) {
        widgetList.forEachIndexed { index, it ->
          var scale by remember { mutableFloatStateOf(it.position.scale) }
          var offsetX by remember { mutableFloatStateOf(it.position.offsetX) }
          var offsetY by remember { mutableFloatStateOf(it.position.offsetY) }
